...
* AES - EBC
*******************/
int aes_encrypt_ebc(const BYTE in[], size_t in_len, BYTE out[], const WORD key[], int keysize)
{
...
int aes_decrypt_ebc(const BYTE in[], size_t in_len, BYTE out[], const WORD key[], int keysize)
{
    BYTE buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE];
    int blocks, idx;
